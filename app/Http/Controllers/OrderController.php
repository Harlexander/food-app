...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'items.*.extraName' => 'nullable|string',
            'items.*.extraPrice' => 'nullable|numeric|min:0',
        ...
        try {
            ...
            foreach ($validated['items'] as $item) {
                ...
                OrderItem::create([
                    ...
                    'food_name' => $item['name'],
                    'size_name' => $item['size'],
                    'extra_name' => $item['extraName'] ?? null,
                    'extra_price' => $item['extraPrice'] ?? null,
            ...
            'order' => [
                ...
                'items' => $order->items->map(function ($item) {
                    return [
                        ...
                        'extra_price' => $item->extra_price ? (float) $item->extra_price : null,
                        'quantity' => $item->quantity,
